            ...
            <VStack alignItems="flex-start" mt=".125in" pr="0.25in" w="100%">
              ...
              <VStack alignItems="flex-start" w="100%">
                ...
                <Heading fontSize="16px" mt="3px!important" w="100%">
                  Axie DoLL - Defenders of Lunacian Land <Box display="inline" fontSize="14px" fontWeight="500">(https://doll.tioland.com)</Box>
                </Heading>
              ...
              <VStack alignItems="flex-start" w="100%">
                ...
                <VStack ml="10px!important" mt="3px!important">
                  <UnorderedList w="100%" mt="0px!important" fontSize="12px">
                    ...
                    <ListItem>
                      Remediate and develop short-term and long-term corrective actions for internal quality issues and customer complaints/inquiries.
                    </ListItem>
                    <ListItem>
